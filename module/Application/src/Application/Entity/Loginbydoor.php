 ...
 * @ORM\Entity
 *
 * @ORM\Table(name="loginbydoor")
 * @property int $id
 * @property int $user_id
 * @property string $user_employeeid
...

{
	...
	/**
	 * Sets the user_uniqueid
	 *
	 * @param string $user_id
	 * @access public
	 * @return login
	 */
	public function setUser_employeeid($user_employeeid)
	{
	...
	/**
	 * Returns the user_uniqueid
	 *
	 * @access public
	 * @return string
	 */
	public function getUser_employeeid()
	{
		return $this->user_employeeid;
	}
