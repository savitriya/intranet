...
(function (t) {
            ...
            if (l) t.isFunction(l) ? (m(), l.call(E, S.clone(), k.clone(), e.timezone, function (t) {
                ...
                if (c) {
                    ...
                    var h = t.extend({}, d || {}),
                        ...
                        y = A(n.endParam, e.endParam),
                        b = A(n.timezoneParam, e.timezoneParam);
        ...
        function u(t) {
            ...
            for (e = 0; W.length > e; e++)
                if (n = W[e], n._id == t._id && n !== t)
                    for (r = 0; B.length > r; r++) a = B[r], void 0 !== t[a] && (n[a] = t[a])
        }
    ...
    function J(e, n, r) {
        ...
        var Y, A, O, W, L, Z, B, P, j, I, q, $, V, X, U, G, Q, J, te, ee, ne, re, ae, oe, ie = H.opt,
            se = H.trigger,
            le = H.renderOverlay,
            ce = H.clearOverlays,
            de = H.daySelectionMousedown,
            ue = H.cellToDate,
            fe = H.dateToCell,
            ve = H.rangeToSegments,
            he = n.formatDate,
    ...
    function ae(n, r, a) {
        ...
        var $, V, X, U, G, Q, J, K, te, ee, ne, re, ae, ie, se, le, ce, de, ue, fe, ve, he, pe, ge, ye, be, we, Se, xe, Me, ze, _e, Re, Fe, Ne, Ye, Ae, Oe, We, Le = q.opt,
            Ze = q.trigger,
            Be = q.renderOverlay,
            Pe = q.clearOverlays,
    ...
    function oe() {
        ...
        function i(e, n) {
            var r, a, o, i, c, d, u, f, m, g, b, w, D, C, S, x, _ = e.length,
                R = "",
                F = E(),
                N = v("isRTL");
        ...
        function c(t, n, r) {
            ...
            n.draggable({
                ...
                stop: function (r, o) {
                    if (d.stop(), $(), h("eventDragStop", n, t, r, o), i) a(), n.css("filter", ""), B(t, n);
                    else {
        ...
        function d(t, e, n) { 
            ...
            var o, i, s, l, c, d, u, p, m, g, y, b, w, D = f.getCoordinateGrid(),
                T = F(),
                C = N(),
                E = Y(),
                S = A();
